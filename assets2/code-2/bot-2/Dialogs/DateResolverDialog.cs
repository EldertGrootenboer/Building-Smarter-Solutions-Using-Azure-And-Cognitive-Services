...
namespace Microsoft.BotBuilderSamples.Dialogs
{
    ...
    {
        private const string PromptMessageText = "When would the visit take place?";
        private const string RepromptMessageText = "I'm sorry, to make your registration please enter a visit date including Day Month and Year.";
